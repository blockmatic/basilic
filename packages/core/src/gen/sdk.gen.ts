 ...
 */
export const accountProfileUpdate = <ThrowOnError extends boolean = false>(options: Options<AccountProfileUpdateData, ThrowOnError>) => (options.client ?? client).patch<AccountProfileUpdateResponses, AccountProfileUpdateErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
    url: '/account/profile/',
    ...options,
    headers: {
 ...
 */
export const oauthGoogleAuthorizeUrl = <ThrowOnError extends boolean = false>(options?: Options<OauthGoogleAuthorizeUrlData, ThrowOnError>) => (options?.client ?? client).get<OauthGoogleAuthorizeUrlResponses, OauthGoogleAuthorizeUrlErrors, ThrowOnError>({ url: '/auth/oauth/google/authorize-url', ...options });
 ...
 */
export const oauthGoogleExchange = <ThrowOnError extends boolean = false>(options: Options<OauthGoogleExchangeData, ThrowOnError>) => (options.client ?? client).post<OauthGoogleExchangeResponses, OauthGoogleExchangeErrors, ThrowOnError>({
 ...
 */
export const oauthGoogleLinkAuthorizeUrl = <ThrowOnError extends boolean = false>(options?: Options<OauthGoogleLinkAuthorizeUrlData, ThrowOnError>) => (options?.client ?? client).get<OauthGoogleLinkAuthorizeUrlResponses, OauthGoogleLinkAuthorizeUrlErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
