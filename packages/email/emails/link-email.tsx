...
export function LinkEmailEmail({ linkUrl, expirationMinutes = 15, fullName = '' }: Props) {
      ...
      <Body className={`my-auto mx-auto font-sans ${themeClasses.body}`} style={lightStyles.body}>
        ...
        >
          ...
          >
            ...
            <br />
            <br />
            Click the button below to link this email to your account. This link will expire in{' '}
