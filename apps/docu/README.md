...
Fumadocs (Next.js 16 + MDX) site for Basilic, the API-first agentic TypeScript swissknife: architecture, ADRs, development, testing, and deployment. Visual language is root `DESIGN.md`.
