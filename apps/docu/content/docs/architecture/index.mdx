...
- [Error handling](/docs/architecture/error-handling) — `@repo/error`, Sentry
- [Logging](/docs/architecture/logging) — Pino server, client wrapper
- [Product analytics](/docs/architecture/analytics) — PostHog
