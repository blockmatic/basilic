...
- [AI](/docs/architecture/ai) — Fastify `/ai/*` control-plane APIs; four planes; chat is demo chrome
- [Eve](/docs/architecture/eve) — Durable agent runtime on a sibling host (queued until E1)
...
- [Frontend](/docs/architecture/frontend) — Next.js 16, React 19, Tailwind 4. No wallet UI in `apps/web`.
