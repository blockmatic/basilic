...
Turborepo owns the OpenAPI → SDK → CLI task graph (`turbo.json` `dependsOn`). See [ADR 001](/docs/adrs/001-monorepo-vs-standalone) and [Development Tooling](/docs/development/dev-tooling).
