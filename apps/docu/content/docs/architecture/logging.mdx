...
Product analytics is not logging: [Analytics](/docs/architecture/analytics). Failures: [Error Handling](/docs/architecture/error-handling). Dashboards, alert rules, runbooks, and post-deployment verification in the running system are **unresolved**.
