---
title: "Testing"
description: "Vitest for the API, packages, and web board compose; Playwright E2E for web."
---
...
- **Web** — Playwright E2E plus compose Vitest in `apps/web/lib/genui`. Commands, fixtures, and specs: [E2E Testing](/docs/testing/e2e-testing).
- **Product Ready** — Generate-and-run checklist for adopters ([Product Ready](/docs/testing/product-ready)). That page is the release bar for R0. CI green is Workflow, not Quality.
