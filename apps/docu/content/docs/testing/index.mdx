...
- **Product Ready** — Fork-and-run checklist for adopters ([Product Ready](/docs/testing/product-ready)). That page is the release bar for R0. CI green is Workflow, not Quality.
...
- **Unresolved** — eval datasets for `/ai/chat` and `/ai/generate`; performance budgets; visual-regression CI. `/use-tdd` is opt-in, not the default for docs or small fixes.
