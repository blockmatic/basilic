---
title: "Testing"
description: "Vitest for the API, packages, and web composeSurface; Playwright E2E for web."
---
...
- **Web** — Playwright E2E plus `composeSurface` Vitest in `apps/web/lib/genui`. Commands, fixtures, and specs: [E2E Testing](/docs/testing/e2e-testing).
...
- **Unresolved** — eval datasets for `/ai/chat` and `/ai/generate`; performance budgets; visual-regression CI. `/w-tdd` is opt-in, not the default for docs or small fixes.
