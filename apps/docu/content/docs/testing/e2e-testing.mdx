...
| `dashboard.spec.ts` | chromium | Coin board (fixture USD, sort, watch, chips, sidebar/rail chrome, `q`, Share, `surface=account`, Who am I?, stubbed missing SpeechRecognition hides mic), profile, 404 |
