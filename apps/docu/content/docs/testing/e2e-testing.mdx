...
3. `test:e2e:local` runs `synpress:build` automatically before Playwright
4. Wallet setup files: `e2e/wallet-setup/metamask.setup.ts`, `e2e/wallet-setup/phantom.setup.ts` (seed: standard test phrase)
