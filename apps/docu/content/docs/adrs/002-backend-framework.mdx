...
- **Vercel runtime**: Fastify on Vercel is one Function + Fluid Compute. Do not move the core API to Edge Runtime. Eve is a **sibling** runtime on a separate host, not a Fastify replacement — [ADR 014](/docs/adrs/014-fastify-eve-vercel-runtime).
...
- [ADR 014: Fastify, eve, and Vercel runtime](/docs/adrs/014-fastify-eve-vercel-runtime) - sibling eve host, Fluid Compute, Node/container exit
