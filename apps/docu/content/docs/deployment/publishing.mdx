...
Packages use **dual-mode exports**: workspace apps import `src/` (no local build); `prepack` rewrites to `dist/` for npm. ESM details: [ESM & TypeScript Strategy](/docs/architecture/esm-strategy).
