...
Run local models with [Ollama](https://ollama.com) to keep prompts and responses on your infrastructure. Recommended when handling sensitive data or avoiding third-party API providers.

See [Self-Hosted LLM](/docs/deployment/self-hosted-llm) for setup instructions and hardware recommendations.
