...
- Verify `VERCEL_TOKEN` and `VERCEL_ORG_ID` are set in GitHub secrets. Workflows set `VERCEL_PROJECT_ID` to project slugs: `basilic-docs`, `basilic-fastify`, `basilic-next`.
