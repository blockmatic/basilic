...
Open Router models support tools (`getAccountInfo`, `braveSearch`). Small Ollama models (e.g. `qwen2.5:3b`) may not; use 7B+ such as `llama3.1:8b` or the runtime default `qwen3:8b` for reliable tool calling.
