...
The Fastify API supports **Anthropic** (default), **Open Router**, and **Ollama**. Routes, env vars, streaming, and generate contract are documented in [AI Architecture](/docs/architecture/ai).
...
- [AI Architecture](/docs/architecture/ai) — Routes, env table, `lib/ai`
