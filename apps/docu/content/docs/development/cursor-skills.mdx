...
The local workflow package is now `b`: `.agents/skills/b/SKILL.md` dispatches to 49 `/b-*` children, including `/b-build`. Shared authoring and completion references travel inside this tree. FIRST and technology skill names are unchanged.
