...
- Onboard new developer — playbook `/onboard-new-developer` when installed under `.agents/skills/workflow/` (see [Cursor Skills workflow package](/docs/development/cursor-skills#workflow-package))
