...
Cursor rules/skills for this repo are already set up. Daily workflow and `/` slash playbooks: [AI Development Workflow](/docs/development/ai-workflow) (Cursor-first; Claude Code uses root `AGENTS.md`). How skills are versioned and updated: [Cursor Skills](/docs/development/cursor-skills). Do the steps below once.
