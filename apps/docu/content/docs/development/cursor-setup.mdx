---
title: "Agent setup"
description: "Optional Cursor adapters: indexed docs and MCP. The contract is AGENTS.md plus .agents/skills/."
---

The portable contract is root `AGENTS.md` and `.agents/skills/` (installed by `pnpm setup`). Daily workflow: [AI Workflow](/docs/development/ai-workflow). Catalog and skills CLI: [Skills](/docs/development/cursor-skills). Named local URLs for any IDE: [Dev Environments](/docs/development/dev-environments).

The steps below are **Cursor extras** (Indexing & Docs, `.cursor/mcp.json`). Other agents skip them and read root `AGENTS.md`.
...
3. Add:
   ...
   - [shadcn Base UI](https://ui.shadcn.com/docs/components/base) (`https://ui.shadcn.com/docs/components/base`)
   - [Base UI](https://base-ui.com/react) (`https://base-ui.com/react`)
...
- **docu**, **fastify**, **next**, **agents**: Vercel project MCP (names are historical; they map to `apps/docu`, `apps/api`, `apps/web`, `apps/agents`)
