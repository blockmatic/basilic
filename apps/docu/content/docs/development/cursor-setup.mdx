...
The portable contract is root `AGENTS.md` and `.agents/skills/` (installed by `pnpm setup`). Daily workflow: [AI Workflow](/docs/development/ai-workflow). Catalog and skills CLI: [Skills](/docs/development/cursor-skills). Ports for any IDE: [Dev Environments](/docs/development/dev-environments).
