...
Cursor rules/skills for this repo are already set up. Daily workflow and `/` slash playbooks: [AI Development Workflow](/docs/development/ai-workflow) (Cursor-first; Claude Code uses the same rules via `CLAUDE.md`). Do the steps below once.
