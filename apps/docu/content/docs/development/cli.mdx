...
The CLI is a simple alternative to MCP for agents (Cursor, Claude Code, scripts). Basilic does not ship an API MCP server.

- Standard stdout/JSON
- No server setup
- Easy to wrap in scripts: `result=$(basilic ai generate --prompt '...')`
