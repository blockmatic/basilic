...
- shadcn: `@repo/ui/components/*` (primitives: `@repo/ui/base`)
- Generated: `packages/core/src/gen`
- Drizzle table barrel: `packages/db/src/schema/index.ts`
...
- [Skills](/docs/development/cursor-skills) — `file-organization` catalog skill
