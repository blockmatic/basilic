...
Related modules belong in a **folder with an index** when they share one concern and the same runtime. This is not a mega-barrel: group indexes are small, cohesive, and scoped to one feature. See [Next.js 16 build rules](/docs/development/cursor-skills) (`next-v16`) for lucide-style barrel anti-patterns.
