...
**Public discovery GETs:** Deployment Protection must not login-wall `/`, `/llms.txt`, `/openapi.json`, or `/.well-known/*` (Is Agentic). The OPTIONS allowlist above is for CORS preflight only.
