 ...
 * It deletes or moves the /src directory to /example based on user input and creates a new /src/app directory with an index.tsx and _layout.tsx file.
...
const moveDirectories = async userInput => {
  try {
    ...
    for (const dir of oldDirs) {
      ...
      else console.log(`➡️ /${dir} does not exist, skipping.`)
    }
