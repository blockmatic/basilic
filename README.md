...
**Setup**
  - `setup` — Full setup (install, hooks, agent skills from basilic-skills `/w-*`, gitleaks, osv, env templates, database, deepsec, Playwright Chromium)
  - `setup:skills` — Install `/w-*` playbooks into `.agents/skills/` (restores `skills-lock.json`)
