...
description: Optimize information architecture following best practices to reduce cognitive load and improve discoverability. Use when the user types /info-architecture.
