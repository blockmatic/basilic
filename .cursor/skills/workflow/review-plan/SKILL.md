---
name: review-plan
description: Review the attached or in-context plan. Use when the user types /review-plan.
...
3. **Dependencies**: Phases ordered correctly; later phases depend on earlier deliverables
4. **Scope**: Each phase has limited, well-defined scope; no scope creep per stage
5. **Output**: Reply in chat only—never create files. Summary, ideas, suggestions, questions, gaps—call out explicitly.
