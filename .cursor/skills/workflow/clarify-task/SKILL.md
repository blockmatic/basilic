---
name: clarify-task
description: Before doing any coding work on the task, ask clarifying questions using multiple choice format to gather requirements around data flow, architecture, APIs, integrations, authentication, edge cases,. Use when the user types /clarify-task.
...
3. **Restate requirements**: After receiving answers, restate final requirements in your own words to confirm understanding
4. **Confirm before proceeding**: Only then ask if they want to proceed to planning/implementation. Defer to user for ambiguous, high-risk decisions.
