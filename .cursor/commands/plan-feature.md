...
2. **Gather context**: Read readme, docs, skills, rules before planning and coding
...
8. **Output structure**: Ensure ## Goals first, ## References (cursor rules and skills used), diagrams where they clarify architecture/flow
