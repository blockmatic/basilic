...
FIRST station skills (`/f-product`, `/f-journeys`, …) are a separate catalog: [`npx skills add blockmatic/first`](https://github.com/blockmatic/first). Do not fork that tree here.
